    ...
    <body id="page-top" class="index">
        ...
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img style="width:200px;height:300px"class="img-responsive" src="img/logo_utn.png" alt="">
                        <div class="intro-text">
                            <span class="name">CHARLAS INFORMATIVAS 2015</span>
                            <hr class="star-light">
                            <span class="skills">Destinadas a Todas las Personas que Deseen Aprender</span>
                        </div>
                    </div>
                </div>
            </div>
