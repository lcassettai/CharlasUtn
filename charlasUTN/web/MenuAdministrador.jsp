<%-- 
    ...
    Created on : 10-nov-2015, 11:39:25
    Author     : Home
--%>
...
<html lang="en">
    ...
    <head>
        <%if (request.getSession().getAttribute("Usuario") == null) { response.sendRedirect("error.jsp");} %>
    ...
    <body id="page-top" class="index">
        ...
        <section >    
            ...
            <div class="well center-block" style="max-width: 500px;margin-top:7%">
            <a type="button" href="CharlasOradores" class="btn btn-primary btn-lg btn-block btn btn-info">Nueva Charla</a>
            <a type="button" href="ObtenerCharlasAbierta" class="btn btn-default btn-lg btn-block btn btn-info">Finalizar Charla</a>
            <a type="button" href="ReportesServlet" class="btn btn-default btn-lg btn-block btn btn-info">Ver Reportes</a>
            </div>
        </section>
